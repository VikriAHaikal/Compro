...
<body>
    <div class="container">
        <h2>Submenu Kelola Header</h2>
        <ul>
            <li><a href="kelola_company.php">Kelola Company</a></li>
            <li><a href="kelola_logo.php">Kelola Logo Perusahaan</a></li>
            <li><a href="kelola_sosmed.php">Kelola Icon Media Sosial</a></li>
